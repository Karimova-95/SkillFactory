...
public class CopyUsingStreamsRW {
    ...
    public static void main(String[] args) {
        try {
            copyFileUsingStream("src/utf8.txt",
                    "UTF-8",
                    "src/win1251.txt",
                    "WINDOWS-1251");
    ...
    private static void copyFileUsingStream(String source,
                                               String sourceEnc,
                                               String dest,
                                               String destEnc) throws ConvertException{
        ...
        try (Reader fis = new InputStreamReader(new FileInputStream(source),Charset.forName(sourceEnc) );
            ...
            throw new ConvertException("Проблема с файлом " + e.getMessage());
        } catch (UnsupportedCharsetException e) {
            throw new ConvertException("Проблема с кодировкой " + e.getMessage());
        } catch (IOException e) {
            throw new ConvertException("Проблемы при копировании");
        }
    }
}
